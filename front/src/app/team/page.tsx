        ...
        <div className="w-full flex flex-row justify-center flex-wrap gap-5 p-20 pt-40">
          {data.map((item) => (
            <div className="w-72 flex flex-col items-center bg-blue-600 rounded-lg border-white border-2 p-3">
              ...
              {item.shiny == true ? <Image src={item.sprites.front_shiny} alt={item.name} width={120} height={120} /> : <Image src={item.sprites.front_default} alt={item.name} width={120} height={120} />}
          ...
          <div className="bg-blue-600 dark:bg-slate-50 p-8 rounded-lg shadow-lg flex items-center justify-center flex-col" >
            <div className="p-2 flex flex-col w-96 bg-opacity-50 z-50">
              ...
              <form className="flex flex-col items-center">
                ...
                {shiny == true ? <Image src={pokemonDetails?.sprites.front_shiny} alt={pokemonDetails?.name} width={200} height={200} /> : <Image src={pokemonDetails?.sprites.front_default} alt={pokemonDetails?.name} width={200} height={200} />}
